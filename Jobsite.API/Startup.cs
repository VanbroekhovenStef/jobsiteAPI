...
namespace Jobsite.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<JobsiteContext>(opt =>
                opt.UseSqlServer(
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, JobsiteContext context)
        {
            if (env.IsDevelopment())
            {
                app.UseDeveloperExceptionPage();
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Jobsite.API v1"));
            }
